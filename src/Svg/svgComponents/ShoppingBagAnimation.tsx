...
const ShoppingBagAnimation = () => {
    ...
    return (
        <div>
            <motion.svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
	                    viewBox="0 0 201.387 201.387" style={{ stroke: "transparent", strokeWidth: 3 }}>

            {/* Top Handle */}
            <motion.path d="M126.292,51.2h-51.2c-1.884,0-3.413-1.529-3.413-3.413V29.013C71.678,13.015,84.693,0,100.692,0
	...
	C178.149,67.604,177.015,68.267,175.785,68.267z M31.626,61.44h138.131l-6.144-10.24H37.772L31.626,61.44z"/>
            ...
            <motion.rect x="105.81" y="27.291"  initial={{ fill: "rgba(131, 216, 22, 0)" }} animate={{ fill: "rgba(131, 216, 22, 1)" }} transition={{ duration: 2 }} style={{  }} width="47.785" height="51.198" />

            {/* Green Cover ---- fill: "#83D816" */}
	...
	C150.096,85.627,148.692,86.688,147.144,86.688z M104.709,69.845l39.885,9.329l10.105-43.204l-39.885-9.329L104.709,69.845z"/>
            ...
            <motion.rect x="42.327" y="16.943"  initial={{ fill: "rgba(42, 142, 230, 0)" }} animate={{ fill: "rgba(42, 142, 230, 1)" }} transition={{ duration: 4 }} style={{  }} width="57.488" height="61.595" />

            {/* Blue Cover ---- fill: "#2A8EE6" */}
	...
	l50.311-5.944l-6.429-54.39L42.699,23.525z"/>
            ...
            <rect
                x="70.59"
                y="41.967"
                transform="matrix(-0.9723 0.2338 -0.2338 -0.9723 211.7695 118.3532)"
                style={{ fill: "#ED5481" }}
                width="56.56"
                height="59.523"
            />

            {/* Pink Cover ---- fill: "#ED5481" */}
	...
	l48.35-11.626L116.876,40.3L68.526,51.925z"/>
            ...
            <motion.polygon animate={{ fill: ["#2A8EE6", "#ED5481", "#83D816", "#FBAD4A"] }} transition={{ duration: 5 }} points="182.612,197.973 18.772,197.973 25.598,64.853 175.785,64.853 " />

            {/* <motion.polygon initial={{ fill: "white" }} animate={{ fill: "white" }} transition={{ duration: 5 }} style={{  }} points="182.612,197.973 18.772,197.973 25.598,64.853 175.785,64.853 " /> */}


            {/* 
                <motion.path d="M182.612,201.387H18.772c-0.935,0-1.83-0.384-2.475-1.062c-0.643-0.678-0.981-1.592-0.934-2.526l6.827-133.12c0.094-1.814,1.592-3.238,3.41-3.238h150.187c1.818,0,3.316,1.423,3.41,3.238l6.827,133.12c0.048,0.935-0.29,1.848-0.934,2.526C184.441,201.003,183.547,201.387,182.612,201.387z M22.364,194.56h156.655l-6.477-126.293H28.841L22.364,194.56z "
            */}
            {/* Lower Bag Cover */}
            <motion.path d="M182.612,201.387H18.772c-0.935,0-1.83-0.384-2.475-1.062c-0.643-0.678-0.981-1.592-0.934-2.526l6.827-133.12c0.094-1.814,1.592-3.238,3.41-3.238h150.187c1.818,0,3.316,1.423,3.41,3.238l6.827,133.12c0.048,0.935-0.29,1.848-0.934,2.526C184.441,201.003,183.547,201.387,182.612,201.387z M22.364, 194.56z"
            initial={{ pathLength: 0, fill: "transparent" }} animate={{ pathLength: 1 }} transition={{ duration: 5 }} style={{ fill: "transparent", stroke: "black", strokeWidth: 8 }}></motion.path>
